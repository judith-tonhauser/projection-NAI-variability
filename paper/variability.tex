...
Experiment 1a was designed to explore the hypothesis that projective content varies in how projective it is, and the hypothesis that the information-structural status of projective content influences its projectivity. The experiment provides empirical support for both hypotheses. Regarding the first hypothesis, we found both within-participant and within-item variability in how robustly projective content projects. Regarding the second hypothesis, we found that the information-structural status of projective content, i.e., how not-at-issue it is, is a significant predictor of its projectivity.

Conventional approaches to projection lead us to expect that different experiment participants will take different projective contents to be robustly and uniformly projective. This expectation derives from the fact that such approaches assume that projectivity derives from a conventionally specified requirement that the relevant content be entailed by or satisfied in the common ground prior to utterance (e.g., \citealt{heim83,vds92}). For instance, if the content of the complement of {\em discover} and {\em annoyed} is conventionally required to be part of the common ground of the interlocutors prior to utterance, then the contents of the complements of these predicates should project equally robustly, and participants should not differ in how much they take the content of the complement to project. Thus, our finding that there is both within-participant and within-item variability in how robustly projective content projects provides an empirical challenge to conventional approaches to projection.

Conventional approaches are not helped here by an appeal to local accommodation, the process by which projective content can be accommodated in the scope of an entailment-canceling operator, e.g., to avoid contradictions, uninformativity or problems with binding (\citealt{heim83,vds92}). For one, local accommodation is a poorly understood process, and hence quite unconstrained. (For relevant discussion see, e.g., \citealt{beaver-zeevat07}.) More importantly, the minimal context in which the stimuli were presented to participants in Experiment 1a do not justify an appeal to local accommodation: given these minimal contexts, why should the content of the complement of {\em discover} be more likely to be accommodated than the content of the complement of {\em annoyed}? 

In general, we take the observation that there is variability in how robustly projective content projects as empirical support for non-conventional approaches to projection, which attempt to derive projectivity from independently-motivated properties of projective content triggers and their use in context (e.g., \citealt{stalnaker74,kempson75,wilson75,boer-lycan76,levinson83,kadmon01,simons01,simons04,atlas05,abusch10,abrusan2011,best-question}). The finding that the information-structural status of projective content is a significant predictor of its projectivity provides empirical support for one specific non-conventional approach to projection, namely that advanced in \citealt{brst-salt10}, according to which projective content projects if and only if it is not at-issue. In Experiment 1b, we examine this hypothesis about projection to a wider range of projective contents, namely the contents of the complements of various (semi-)factive predicates.
...
Like Experiment 1a, Experiment 1b was designed to explore the hypothesis that projective content varies in how projective it is, and the hypothesis that the information-structural status of projective content influences its projectivity. Experiment 1b provides further empirical support for both hypotheses, now from polar questions with (semi-)factive predicates. Regarding the first hypothesis, we again found again within-participant and within-item variability in how robustly projective content projects. Regarding the second hypothesis, we again found that the information-structural status of projective content, i.e., how not-at-issue it is, is a significant predictor of its projectivity.

The findings of this experiment further extend the challenge to conventional approaches to projection and further support the hypothesis advanced in \citealt{brst-salt10}, according to which projective content projects if and only if it is not at-issue. 
...
\begin{figure}[!h]
\begin{center}
\fbox{\includegraphics[width=12cm]{exp2-trial}}
\end{center}
...
The boxplots in Figure \ref{f-ai-2a} 
