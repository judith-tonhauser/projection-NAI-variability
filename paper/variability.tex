...
\title{At-issueness predicts projection variability\thanks{Our thinking about projective content and the research reported on in this paper has been influenced greatly by discussions with Craige Roberts and Mandy Simons. For helpful feedback, we also thank M\'arta Abrus\'an, XXX, the audiences at YYY, as well as David Barner and three anonymous reviewers of {\em Journal of Semantics}. This work was partially supported by NSF grants BCS-1452674 (JT) and BCS-1452663 (DIB).}}
